...
#define  _FIGURE_NAME_ "fig_distpt_pion"
#define  _N_HISTOGRAMS_ 4

void figure_distpt_pion(TString aEventDir = "./events/", Int_t aEventFiles = 1)
{
// ##########################################################################
// # READ ROOT FILES
// ##########################################################################
...
// Fill histograms
  ...
  for(Int_t i=0; i<Chain->GetEntries(); i++) {
    ...
    if((fatherpid == 113) || (fatherpid == 213))
...
// Canvas
  ...
  gPad->SetLogy();
// Histogram legend
  TLegend* LegendPart	= new TLegend(0.17, 0.18, 0.57, 0.42, "",	"brNDC");
