...
#include <cstdio>
#include <TChain.h>
#include "/u/sudol/apr12/loopDST/gen8/heidi/therminator2_2.0.3/therminator2_2.0.3_coul/build/include/ParticleCoor.h"
#include "/u/sudol/apr12/loopDST/gen8/heidi/therminator2_2.0.3/therminator2_2.0.3_coul/build/include/StructEvent.h"
...
// ##########################################################################
  ...
  Int_t start = 0;
    ...
    for(Int_t i=start; i<start+aEventFiles; i++) {
    char Buff[100];
...
TChain* events2chainBatch(TString aEventDir, Int_t aEventDirs, Int_t aEventFiles, ParticleCoor* aParticle, Int_t* aEvents)
{
// ##########################################################################
// WHICH ROOT FILES TO READ
// ##########################################################################
  ...
  for(Int_t j=startC; j<startC+aEventDirs; j++) {
