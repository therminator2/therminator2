...
submissiondir="/lustre/hades/user/harabasz/submit/CaseMarvin_CodeJedrzej"
outputdir="/lustre/hades/user/harabasz/CaseMarvin_CodeJedrzej"
...
command="sbatch --array=1-{3} --mem=3000 --time=0-2:00:00 --partition=long -D {0}  --output={1}/out/slurm-%A_%a.out -- {0}/jobScript_SL.sh {0}/jobarray.dat {1} {2}".format(submissiondir,outputdir,scriptdir,arrElem+1)
print(command)
os.system(command)
