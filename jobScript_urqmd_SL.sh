...
#   EDIT THIS PART TO EXECUTE YOUR JOB!
  ...
  ldd therm2_events
  ./therm2_events
  export ftn09=./Au_Au_1230MeV_bmax10_f15.input
  export ftn10=./sr/events.f10
  export ftn14=./sr/events.f14
  export ftn15=./sr/events.f15
  /cvmfs/hadessoft.gsi.de/install/debian10/urqmd-3.4/urqmd
#  /lustre/hades/user/harabasz/urqmd-3.4/urqmd.x86_64
  /lustre/hades/user/harabasz/unigen_new/UniGen-2.3/bin/urqmd2u_f15 ./sr/events.f15 ./sr/events.root 1000
  cd ..
